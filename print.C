...
void colour();
int errno; //needed by some libc/libm functions
void basicmain(); //main function declaration
double y; //needed by some libc/libm functions
double yt2; //needed by some libc/libm functions
struct exception {
...
struct exception xcpt; //needed by some libc/libm functions
static int     a;
static int     b;
static int     c;
static char    d[2048];
...
int basic_r_indx=0;
int basic_r_size=0;
volatile void RPRINT();
volatile void LOCATE(int x, int y);
char *arse="foooooooooooook\377";
...
void basicmain()
{
//sprintf(basic_r_buffer,"%s% d% d% d%s\n","bellooooooooooo",(int)a,(int)b,(int)c,d);
...
basic_r_size=0;
  ...
  LOCATE(10,10);
  basic_r_buffer=(char *)arse;
  RPRINT();
  LOCATE(20,30);
  basic_r_buffer=(char *) "bellooooooooooo\377";
  RPRINT();
