...
sample6:	dc.l	sfx_gnome						; start of sample - just the external label to U235 here
			dc.l	sfx_gnome_end					; end of sample - the external label to U235 with an added _end suffix
			dc.l	0								; loop - start position
			dc.l	0								; loop - end position
			dc.w	0								; <NULL>
			dc.b	0								; fine tune
...
sample8:	dc.l	sfx_intro						; start of sample - just the external label to U235 here
			dc.l	sfx_intro_end					; end of sample - the external label to U235 with an added _end suffix
			dc.l	0								; loop - start position
			dc.l	0								; loop - end position
			dc.w	0								; <NULL>
			dc.b	0								; fine tune
...
sample9:	dc.l	sfx_theme						; start of sample - just the external label to U235 here
