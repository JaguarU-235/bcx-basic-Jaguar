...
;			value						possible values				description															rb+ label to access
	...
	dc.w	18,0				; 									; Put sprite this many pixels from left side of screen.				;   R_sprite_x
	dc.w	50,0				; 									; Put sprite this many pixels down from top of screen.				;   R_sprite_y
	dc.w	0,0				; 									; How many pixels will this sprite move automatically in x?			;   R_sprite_xadd
	dc.w	0,0				; 									; How many pixels will this sprite move automatically in x?			;   R_sprite_xadd
	dc.l	320				; 									; Width of sprite in pixels											; * R_sprite_width
	dc.l	130				; 									; Height of sprite in pixels										; * R_sprite_height
	...
	dc.l	SPR_CANVAS	;									; Place in memory where the sprite lives: label from RAPAPP.S		;   R_sprite_gfxbase
	...
	dc.l	320*150*2		; 									; Size of sprite in bytes - used to find next frame of animation	;   R_sprite_framesz
																...
																; *2 for 16bit
																; *4 for 24bit
	dc.l	320*2			; 									; Width of a single row of sprite pixels							; * R_sprite_bytewid
	...
	dc.l	320*2			;									; Width of sprite within larger graphic.							;   R_sprite_gwidth
																; Enter the x-size and add the following:
																; /8 for 1bit
																; /4 for 2bit
																; /2 for 4bit
