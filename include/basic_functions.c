...
"                                                                                  \n\t"
"                                                                                  \n\t"
"GPIO_0      =    0xf14800    |General purpose I/O #0                           \n\t"
"GPIO_1      =    0xf15000    |General purpose I/O #1                           \n\t"
"JOYSTICK       =     0xF14000\n\t"
"                                                                                  \n\t"
"|   Equates derived from the above                                                \n\t"
"|   to allow indirect with 16-bit displacement addressing                         \n\t"
"                                                                                  \n\t"
"GPIO_0of    =    GPIO_0-JOYSTICK |offset to GPIO_0 (when addr reg Ax -> JOY1)  \n\t"
"GPIO_1of    =    GPIO_1-JOYSTICK |offset to GPIO_1 (when addr reg Ax -> JOY1)  \n\t"
"                                                                                  \n\t"
"|   Commands tested on:                                                           \n\t"
...
"|        876543210                                                                \n\t"
"                                                                                  \n\t"
"eREAD       =    0b110000000      |read from EEPROM                             \n\t"
"eEWEN       =    0%100110000      |Erase/write Enable                           \n\t"
"eWRITE      =    0%101000000      |Write selected register                      \n\t"
"eEWDS       =    0%100000000      |Erase/Write disable (default)                \n\t"
"                                                                                  \n\t"
"|;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;     \n\t"
...
"        tst.w   GPIO_1of(a0)    |strobe ChipSelect                                \n\t"
"                                                                                  \n\t"
"        andi.w  #0x3f,d1     |force write addr to be legit (0-63)                  \n\t"
...
"        tst.w   GPIO_1of(a0)    |strobe ChipSelect                                \n\t"
"                                                                                  \n\t"
"        andi.w  #0x3f,d1     |force legit read addr                                \n\t"
"        ori.w   #eREAD,d1                                                         \n\t"
"        move.w  d1,d2                                                             \n\t"
"        bsr.s   out9bits                                                          \n\t"
"                                                                                  \n\t"
