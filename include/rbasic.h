...
extern unsigned long zero_mousex_delta asm("zero_mousex_delta");
extern unsigned long zero_mousey_delta asm("zero_mousey_delta");
extern unsigned long zero_rotary_delta asm("zero_rotary_delta");
